...
import {getFontWeightMedium, formatNumberToMoney } from '../../utils/utils';
import TransactionStatus from '../../utils/TransactionStatus';
import I18n from '../../utils/I18n';
import ImageAssets from '../../utils/ImageAssets';
import anim_pending from '../../assets/json/anim_pending.json';
...
const PaymentStatus = (props) => {
    ...
    const getIconByStatus = () => {
        const icon = { uri: ImageAssets.ic_success };

        return icon;
    };

    const getWalletBallance = () => formatNumberToMoney(postBalance);
    ...
    const renderTotalValue = () => {
        ...
        return (
            <Text.Title style={styles.originalAmount}>{formatNumberToMoney(totalOriginalAmount)}</Text.Title>
        );
    };
