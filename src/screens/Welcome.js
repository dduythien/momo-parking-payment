...
import { Spacing, Colors, Text, Button } from '@momo-kits/core';
import { BottomSelectionList } from '@momo-kits/selection'
            ...
            <View style={styles.container}>
                ...
                onPress={() => {
                    ...
                    navigator.showBottom({
                        screen: BottomSelectionList,
                        params: {
                            dragDisabled: true,
                            title: 'Thay đổi nhà mạng',
                            body: 'Vui lòng chỉ thay đổi nàh mạng khi bạn đã đăng ký giữ số chuyển mạng',
                            data: data1,
